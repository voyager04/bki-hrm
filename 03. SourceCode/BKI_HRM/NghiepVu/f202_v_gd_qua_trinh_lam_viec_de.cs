...
namespace BKI_HRM
{
    public partial class f202_v_gd_qua_trinh_lam_viec_de : Form
    {
        ...
        public void display_for_update(US_V_GD_QUA_TRINH_LAM_VIEC ip_us_trang_thai_ld)
        {
            m_us_v_trang_thai_ld = ip_us_trang_thai_ld;
        ...
        US_V_GD_QUA_TRINH_LAM_VIEC m_us_v_trang_thai_ld = new US_V_GD_QUA_TRINH_LAM_VIEC();
        DS_V_GD_QUA_TRINH_LAM_VIEC m_ds_v_trang_thai_ld = new DS_V_GD_QUA_TRINH_LAM_VIEC();
        US_GD_CHI_TIET_CHUC_VU m_us_trang_thai_ld = new US_GD_CHI_TIET_CHUC_VU();
        ...
        private void f202_v_gd_qua_trinh_lam_viec_de_Load(object sendrer, EventArgs e)
        {
            try
            {
