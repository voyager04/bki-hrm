    ...
    public class ReportController : Controller
    {
        ...
        public ActionResult GetNhanVienByPhongBan(string ipMaDonVi)
        {
            ...
            return Json(v_NhanVien.Select(m => new
            {
                ...
                NGAY_BAT_DAU_CHUC_VU = m.NGAY_BAT_DAU.HasValue ? m.NGAY_BAT_DAU.Value : m.NGAY_BAT_DAU.GetValueOrDefault(),
                NGAY_KET_THUC_CHUC_VU = m.NGAY_KET_THUC.HasValue ? m.NGAY_KET_THUC : m.NGAY_KET_THUC.GetValueOrDefault(),
                MA_QUYET_DINH = m.MA_QUYET_DINH,
                LOAI_QUYET_DINH = m.LOAI_QD,
                NGAY_BAT_DAU_QUYET_DINH = m.NGAY_CO_HIEU_LUC.HasValue ? m.NGAY_CO_HIEU_LUC.Value : m.NGAY_CO_HIEU_LUC.GetValueOrDefault(),
                NGAY_KET_THUC_QUYET_DINH = m.NGAY_HET_HIEU_LUC.HasValue ? m.NGAY_HET_HIEU_LUC : m.NGAY_HET_HIEU_LUC.GetValueOrDefault(),
                NGACH = m.NGACH,
