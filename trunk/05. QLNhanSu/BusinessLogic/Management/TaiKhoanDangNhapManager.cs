...
namespace BusinessLogic.Management
{
    public class UserManager
    {
        ...
        public bool CheckProfileIsFull(string ip_str_user)
        {
            ...
            {
                if (v_ht_user.HO == "" | v_ht_user.HO == null) v_b_result = false;
                if (v_ht_user.TEN == "" | v_ht_user.TEN == null) v_b_result = false;
                if (v_ht_user.BHYT == "" | v_ht_user.BHYT == null) v_b_result = false;
                if (v_ht_user.CMND == "" | v_ht_user.CMND == null) v_b_result = false;
                if (v_ht_user.MSBN == "" | v_ht_user.MSBN == null) v_b_result = false;
            }
            return v_b_result;
        }
        ...
        public void InsertIfDoNotHaveUser(string ip_str_user)
        {
            ...
            var v_lst_user = uow.Repository<HT_USER>().Query().Filter(x => x.USERNAME == v_str_user + "@topica.edu.vn" | x.USERNAME == v_str_user + "@gmail.com").Get();
