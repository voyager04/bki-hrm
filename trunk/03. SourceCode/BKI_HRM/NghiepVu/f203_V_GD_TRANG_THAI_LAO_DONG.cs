...
namespace BKI_HRM
{
	...
	public class f203_v_gd_trang_thai_lao_dong : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.m_grv_trang_thai_ld.Location = new System.Drawing.Point(0, 177);
            this.m_grv_trang_thai_ld.Name = "m_grv_trang_thai_ld";
            this.m_grv_trang_thai_ld.Size = new System.Drawing.Size(1284, 448);
...
,NGAY_CO_HIEU_LUC = 7
        ...
        private void load_custom_source_2_m_txt_tim_kiem()
        {
            ...
            foreach (DataRow dr in m_ds.V_GD_TRANG_THAI_LAO_DONG)
            {
                v_acsc_search.Add(dr[V_GD_TRANG_THAI_LAO_DONG.MA_NV].ToString());
                v_acsc_search.Add(dr[V_GD_TRANG_THAI_LAO_DONG.HO_DEM].ToString() + " " + dr[V_GD_TRANG_THAI_LAO_DONG.TEN].ToString());
                v_acsc_search.Add(dr[V_GD_TRANG_THAI_LAO_DONG.TEN].ToString());
            }
