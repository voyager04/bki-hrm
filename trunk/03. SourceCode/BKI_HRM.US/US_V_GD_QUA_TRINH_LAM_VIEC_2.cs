...
namespace BKI_HRM.US
{
    ...
    public class US_V_GD_QUA_TRINH_LAM_VIEC_2 : US_Object
    {
        ...
        #endregion
        #region Addtional
        public void FillDatase_NhanSu_TheoPhongBan(DS_V_GD_QUA_TRINH_LAM_VIEC_2 op_ds, string ip_str_search, DateTime ip_dat_thoi_diem)
        {
        ...
        public void count_nhan_vien_theo_phong_ban(DS_V_GD_QUA_TRINH_LAM_VIEC_2 op_ds, string ip_str_search, DateTime ip_dat_thoi_diem, ref decimal op_count)
        {
