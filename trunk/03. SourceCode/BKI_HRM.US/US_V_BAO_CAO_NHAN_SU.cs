...
/// Date: 23/02/2014 04:18:47
/// Goal: Create User Service Class for V_BAO_CAO_NHAN_SU
///************************************************
/// <summary>
/// Create User Service Class for V_BAO_CAO_NHAN_SU
/// </summary>
...
public class US_V_BAO_CAO_NHAN_SU : US_Object
{
	private const string c_TableName = "V_BAO_CAO_NHAN_SU";
...
#region "Init Functions"
	public US_V_BAO_CAO_NHAN_SU() 
	{
		pm_objDS = new DS_V_BAO_CAO_NHAN_SU();
		pm_strTableName = c_TableName;
		pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
	}

	public US_V_BAO_CAO_NHAN_SU(DataRow i_objDR): this()
	{
		this.DataRow2Me(i_objDR);
	}

	public US_V_BAO_CAO_NHAN_SU(decimal i_dbID) 
	{
		pm_objDS = new DS_V_BAO_CAO_NHAN_SU();
		pm_strTableName = c_TableName;
